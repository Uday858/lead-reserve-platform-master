...
<html lang="{{ app()->getLocale() }}">
	...
	<body>
			...
			<table>
				...
				<tr>
					<td align="right"><strong>Main Contact</strong></td>
					<td align="left"><strong>{{$publisher->hasAttributeOrEmpty('publisher_poc_main_name')}}</strong></td>
				</tr>
				<tr>
					<td align="right"><strong>Email</strong></td>
			...
			<p>The Publisher will supply the Advertiser with leads in real time from their owned and operated sites. See posting instructions for campaign posting specs and creatives.</p>
